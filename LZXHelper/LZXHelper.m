...
+ (NSString *)getFullPathWithImageFile:(NSString *)urlName {
    ...
    //拼接路径
    return [myCacheDirectory stringByAppendingPathComponent:[NSString stringWithFormat:@"%@.png",newName]];
}
...
+ (NSString *)getFullPathWithFile:(NSString *)urlName {
    ...
    //拼接路径
    return [myCacheDirectory stringByAppendingPathComponent:[NSString stringWithFormat:@"%@",newName]];
}
//检测 缓存文件 是否超时
